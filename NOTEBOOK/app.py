...
def extract_all_reviews(url, clean_reviews, org_reviews, customernames, commentheads, ratings):
    ...
    ratings_ = page_html.find_all('div',
                                  {'class': ['_3LWZlK _1BLPMq', '_3LWZlK _32lA32 _1BLPMq', '_3LWZlK _1rdVr6 _1BLPMq']})
...
# this was the code for Flipkart Reviews extraction and sentiment analysisimport re
# import os
# import nltk
# import joblib
# import requests
